    ...
    <div class="card-body">
        ...
        <form action="tr_penjualan-proses.php" method="POST">
            <div style="margin-bottom: 1em;">
                ...
                <div class="card">
                    <div class="card-header">Input Pembeli</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <select class="form-control" name="pembeli">
                                    <option value="" selected="selected">Pilih Pembeli</option>
                                    <?php
                                    // query untuk menampilkan nama dari tabel 
                                    $query = "SELECT * FROM pembeli";
                                    $hasil = mysqli_query($conn, $query);
                                    while ($data = mysqli_fetch_array($hasil)) {
                                    echo "<option value='" . $data['nip'] . "'>" . $data['nama_depan'] . "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
